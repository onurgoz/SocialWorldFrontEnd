...
@Component({
  selector: 'app-city-social-responsibility',
  templateUrl: './city-social-responsibility.component.html',
  styleUrls: ['./city-social-responsibility.component.scss']
})
export class CitySocialResponsibilityComponent implements OnInit {

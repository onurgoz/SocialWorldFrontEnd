...
@Component({
  selector: 'app-add-social-responsibility-city',
  templateUrl: './add-social-responsibility-city.component.html',
  styleUrls: ['./add-social-responsibility-city.component.scss']
})
export class AddSocialResponsibilityCityComponent implements OnInit {
